        ...
        <div class="col-12">
            ...
            <div class="row  ">
                <div class="col-12  m-auto ">
                    <div class="card">
                        <div class="card-body">
                        <!-- <form action="<?php echo base_url(); ?>insert_hotel_room" method="post" enctype="multipart/form-data"> -->
...
$(document).ready(function() {
    $('#hotelRoomForm').submit(function(event) {
       ...
       var subfacilityChecked = false;
        ...
        $.ajax({
            url: '<?php echo base_url('insert_hotel_room'); ?>', // Replace with your actual URL
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            success: function(response) {
               ...
               // location.reload();
                 window.location.href = '<?php echo base_url('hotel_added_rooms'); ?>';
            },
            error: function(xhr, status, error) {
