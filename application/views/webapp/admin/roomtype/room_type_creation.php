         ...
         <div class="col-12">
             ...
             <div class="row  ">
                 <div class="col-12  m-auto ">
                     <div class="card">
                         <div class="card-body">
                         <form action="<?php echo base_url(); ?>room_type_reg" method="post" enctype="multipart/form-data">
                                         ...
                                         <div class="row mt-3">
                                             <div class="col-12 col-sm-6">
                                                 <div class="input-group input-group-static ">
                                                     ...
                                                     <input class="form-control" name="roomtypename" type="text" placeholder="Room Type Name" required/>
                                                 </div>
                                             </div> 
                                            ...
                                            <div class="col-12 col-sm-6">
                                             ...
                                             <!--        <input class="form-control custom-file-upload" name="roomtype_image" type="file" required>-->
                                             <!--    </div>-->
                                             <!--</div>-->
                                         </div>
