         ...
         <div class="col-12">
             ...
             <div class="row  ">
                 <div class="col-12  m-auto ">
                     <div class="card">
                         <div class="card-body">
                         <form action="<?php echo base_url(); ?>category_reg" method="post" enctype="multipart/form-data">
                                 <div class="border-radius-xl bg-white">
                                     <h5 class="font-weight-bolder mb-2">Category Creation</h5>
                                     <div class=" "> 
                                         <div class="row mt-3">
                                             <div class="col-12 col-sm-6">
                                                 <div class="input-group input-group-static ">
                                                     <label class=" "> Category</label>
                                                     <input class="form-control" name="roomtypename" type="text" placeholder="Category Name" required/>
                                                 </div>
                                             </div> 
                                            <div class="col-12 col-sm-6">
                                             <div class="input-group input-group-static">
