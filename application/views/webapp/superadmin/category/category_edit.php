        ...
        <div class="col-12">
            <div class="row">
                <div class="col-12 m-auto">
                    <div class="card">
                        <div class="card-body">
                            <form action="<?php echo base_url(); ?>categoryupdate" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="category_id" value="<?php echo $categorys[0]->category_id; ?>">
                                <div class="border-radius-xl bg-white">
                                    <h5 class="font-weight-bolder mb-2">Categorys</h5>
                                    <div class="">
                                        <div class="row mt-3">
                                            <div class="col-12 col-sm-6">
                                                <div class="input-group input-group-static">
                                                    <label class="">Category</label>
                                                    <input class="form-control" name="roomtypename" value="<?php echo $categorys[0]->category_name; ?>" type="text" placeholder="Item Name" required />
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="input-group input-group-dynamic">
                                                    <div class="input-group input-group-static">
                                                        ...
                                                        <div class="mb-3">
                                                            <?php if (!empty($categorys[0]->category_image)): ?>
                                                                <img src="<?php echo base_url('upload/category_images/' . $categorys[0]->category_image); ?>" alt="Type Image" style="max-width: 200px;" id="currentTypeImage">
                                                            <?php else: ?>
                                                                <p>No image uploaded for this Category.</p>
                                                                <img id="currentTypeImage" style="max-width: 200px;">
                                                            <?php endif; ?>
                                                        </div>
                                                        <input type="hidden" name="existing_type_image" value="<?php echo $categorys[0]->category_image; ?>">
                                                        <div class="mb-3">
                                                            <label for="typeImageInput" class="form-label">Upload New Image</label>
                                                            <input class="form-control" id="typeImageInput" name="roomtype_image" type="file" accept="image/*" onchange="previewTypeImage(event)" <?php echo empty($categorys[0]->category_image) ? 'required' : ''; ?>>
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="col-12 col-sm-6 mt-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="active-inactive" <?php echo $categorys[0]->status ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="active-inactive">Active Or Inactive</label>
                                        </div>
                                    </div>
                                </div>
                                <input type="hidden" id="status" name="status" value="<?php echo $categorys[0]->status; ?>">
