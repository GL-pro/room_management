                    ...
                    <div class="d-lg-flex">
                        ...
                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                            ...
                            <!-- <a href="unapproved_room_type_list"><button class="btn bg-gradient-warning btn-sm mb-0" type="button">unapproved list </button></a> -->
                                <a href="subcategory_creation" class="btn bg-gradient-dark btn-sm mb-0">+ Add Subcategory</a>
                ...
                <div class="card-body px-0 pb-0">
                    <div class="table-responsive">
                        <table class="table table-flush" id="sub-category-list">
                            ...
                            <tbody>
                                <?php foreach ($subcategorys as $index => $subcategory): ?>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <h6 class="ms-3 my-auto"><?php echo $subcategory->subcategory_name; ?></h6>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <h6 class="ms-3 my-auto"><?php echo $subcategory->category_name; ?></h6>
                                        </div>
                                    </td>
                                    <td class="align-middle text-center text-sm">
                                        <div class="form-check form-switch">
                                         <input class="form-check-input text-center room-status-switch" type="checkbox" id="regionToggle_<?php echo $subcategory->subcategory_id; ?>" <?php echo ($subcategory->status == 1) ? 'checked' : ''; ?> data-region-id="<?php echo $subcategory->subcategory_id; ?>"> 
                                        </div>
                                    </td>
                                    <td class="text-sm text-center">
                                        <a href="<?php echo base_url();?>subcategory_edit/<?=$subcategory->subcategory_id;?>" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Edit Category">
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            url: '<?php echo base_url("Superadmin/update_status_subcategory"); ?>',
            method: 'POST',
            data: { subcategory_id: roomId, status: status }, // Send room_id and status as data
